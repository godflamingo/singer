...
mkdir /tmp/sing
mkdir /etc/sing-box
curl --retry 10 --retry-max-time 60 -L -H "Cache-Control: no-cache" -fsSL github.com/SagerNet/sing-box/releases/download/v1.0.4/sing-box_1.0.5_linux_amd64v3.deb
 -o /tmp/sing/sing-box_1.0.5_linux_amd64v3.deb
